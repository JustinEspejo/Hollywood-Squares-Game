...
public class DataEventController implements ActionListener{
        ...
        while( !player[0].checkGameWin() && !player[1].checkGameWin() ){
        	while(!board.checkRoundWin(player[0].getPlayerSymbol())&&!board.checkRoundWin(player[1].getPlayerSymbol())){
	            ...
	            if(aiMode) {
	            	...
	            	System.out.println();
	            	System.out.println("Type any of the following character for their function during your turn");
	                ...
	                System.out.println("Host: Please pick a square. ");
	                ...
	                System.out.println("Host: Do you agree with Celebrity ? agree(true) disagree(false)");
	                ...
	                if (question.checkAnswer(answer, fakeAnswer)) {
	                    System.out.println("Host: You are correct! The Celebrity's answer is indeed " + answer + ".");
	                    board.setBoard(boxNumber, player[currentTurn - 1].getPlayerSymbol());
	                } else {
	                    System.out.println("Host: I'm sorry, you're wrong. The Celebrity's answer is " + !answer + ".");
    ...
    public static void main(String[] args){
    	try {
	    	...
	    	String savedFile = args[0];
	    	while(true){
	    		DataEventController dec;
	        	Scanner sc = new Scanner(System.in);
	        	int playerAmount; String playMode;
		    	System.out.println("Welcome to Play HollyWood Sqaure!");
		    	System.out.println();
		    	System.out.println("Please choose one of the following options by type in the corresponding character");
		    	System.out.println();
		            ...
		            if(playMode.equalsIgnoreCase("N")) {
		               ...
		               if(playerAmount==1)
		                ...
		                break;
		            		...
		            		if(!inFile.hasNext()){
		            			System.out.println("There's no game file saved");
		            		}
		            		else{
